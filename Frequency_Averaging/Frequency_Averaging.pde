/**
  * This sketch is a mix of the two following sketch examples: 
  * http://code.compartmental.net/minim/fft_method_logaverages.html 
  * http://code.compartmental.net/minim/fft_method_window.html
  *
  *
...
FFT fftLin;
FFT fftLog;
String windowName = "Rectangular Window";
...
void setup()
{
  ...
  jingle = minim.getLineIn(Minim.STEREO, int(2048));
